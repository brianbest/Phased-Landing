...
<div class="modal fade" id="emailModal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- Begin MailChimp Signup Form -->
            ...
            <form action="//phased.us10.list-manage.com/subscribe/post?u=e5e8eb3e2282a802b7562fe78&amp;id=130415f934" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            ...
            <div class="mc-field-group">
                ...
                <div style="position: absolute; left: -5000px;"><input type="text" name="b_e5e8eb3e2282a802b7562fe78_130415f934" tabindex="-1" value=""></div>
  ...
  ga('create', 'UA-61513172-1', 'auto');
  ga('send', 'pageview');



  var downloadLink = document.getElementById('playvid');
    addListener(downloadLink, 'click', function() {
  ga('send', 'event', 'button', 'click', 'video-play');
});
